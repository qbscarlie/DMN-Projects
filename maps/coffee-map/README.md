...
`gulp publish` will upload your [`dist/`](dist/) folder to the `embeds/2017/coffee-map/` folder on our interactives S3 bucket.
...
```html
<div id="embed-coffee-map"></div>

<script src="//pym.nprapps.org/pym.v1.min.js"></script>
<script>new pym.Parent('embed-coffee-map', '//interactives.dallasnews.com/embeds/2017/coffee-map/', {})</script>
```
