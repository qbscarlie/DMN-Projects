...
`gulp publish` will upload your [`dist/`](dist/) folder to the `embeds/2017/spooky-map/` folder on our interactives S3 bucket.
...
```html
<div id="embed-spooky-map" class="embed-preview"></div>

<script src="//pym.nprapps.org/pym.v1.min.js"></script>
<script>new pym.Parent('embed-spooky-map', '//interactives.dallasnews.com/embeds/2017/spooky-map/', {})</script>
```
