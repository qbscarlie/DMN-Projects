...
`gulp publish` will upload your [`dist/`](dist/) folder to the `embeds/2017/waterparks/` folder on our interactives S3 bucket.
...
```html
<div id="embed-waterparks" class="embed-preview"></div>

<script src="//pym.nprapps.org/pym.v1.min.js"></script>
<script>new pym.Parent('embed-waterparks', '//interactives.dallasnews.com/embeds/2017/waterparks/', {})</script>
```
